...
//    ]
//    
//    init(version: TrackerTypeViewController.TrackerVersion, data: Tracker.Track = Tracker.Track(), descr: TrackerCategory.TrackCategory = TrackerCategory.TrackCategory(), trackerToEdit: Tracker? = nil, trackerCategory: String? = nil) {
...
//            self.data.name = trackerToEdit.name
//            self.data.color = trackerToEdit.color
//            self.data.emoji = trackerToEdit.emoji
//            self.data.schedule = trackerToEdit.schedule
//            self.descr.title = trackerCategory
//        } else {
//            switch version {
//            case .habit:
//                self.data.schedule = []
...
//            case .edit: 
//                if ((trackerToEdit?.schedule?.isEmpty) != nil) {
//                    self.data.schedule = trackerToEdit?.schedule
//                } else {
//                    self.data.schedule = []
//                }
...
//            guard let trackerToEdit = trackerToEdit else { return }
//            nameTracker.text = trackerToEdit.name
//            selectedEmoji = trackerToEdit.emoji
//            selectedColor = trackerToEdit.color
//            data.schedule = trackerToEdit.schedule
//            
//            // Найдите индекс выбранного эмодзи и цвета для выделения в коллекции
//            if let emojiIndex = emoji.firstIndex(of: trackerToEdit.emoji) {
//                selectedEmojiIndex = emojiIndex
//            }
//            if let colorIndex = trackerColors.firstIndex(of: trackerToEdit.color) {
//                selectedColorIndex = colorIndex
//            }
//            
//            emojiAndColorCollectionView.reloadData() // Обновите коллекцию для отображения выделенных элементов
//        }
//    
...
//            
////            if let trackerToEdit = trackerToEdit {
////                trackerToEdit.name = data.name
////                trackerToEdit.emoji = emoji
////                trackerToEdit.color = color
////                trackerToEdit.schedule = data.schedule
////                delegate?.didTapCreateButton(category: category, tracker: trackerToEdit)
//        if let trackerToEdit = trackerToEdit {
...
//            isPinned: false)
//            if let category = try? findCategoryByTracker(tracker: newTracker) {
//                delegate?.updateTracker(tracker: newTracker, to: category)
//    //
...
//            }
////            trackerCategory = findCategoryByTracker(tracker: newTracker)
////        delegate?.updateTracker(tracker: newTracker, to: trackerCategory)
//            } else {
//                let createNewTracker = Tracker(id: UUID(), name: data.name, color: color, emoji: emoji, schedule: data.schedule, isPinned: false)
//                delegate?.didTapCreateButton(category: category, tracker: createNewTracker)
//            }
...
//        case .edit:
//            if let trackerToEdit = trackerToEdit {
//                if trackerToEdit.schedule!.isEmpty {
//                    return 1
//                } else {
//                    return 2
//                }
...
//        guard let cell = tableView.dequeueReusableCell(withIdentifier: CreatingCell.identifier, for: indexPath) as? CreatingCell else { return UITableViewCell() }
...
//            }
//            
//            cell.nameLabel.text = parametres[indexPath.row]
//            
